const ConfigResignForm = {
  ApprovalFlow: {
    WorkSheet: '11IvmHwOXEArlnUavgjFFl7pJWlFuBgVcZPQ982B6ej4',
...
function SubmitResignForm() {
  ...
  this.sendCompletedNotification = (taskId) => {
    ...
    const email = ConfigResignForm.ApprovalFlowForms.NotificationEmail
    const options = {
      htmlBody: template.evaluate().getContent()
    }
    GmailApp.sendEmail(email, subject, "", options)
...
// function test() {
//   const app = new SubmitResignForm()
//   const taskId = 'ODM1YmJiODUtZGFmMi00ZDllLTgwYjEtZTU4NTIzMDUwYzFi'
//   app.sendCompletedNotification(taskId)
// }