...
function getApprovalFlowsReviewForm() {
  const sheet = SpreadsheetApp.openById(CONFIG.DATABASE.REVIEW);
  const data = sheet.getSheetByName(CONFIG.SHEET_NAME.REVIEW_APPROVAL_FLOW).getDataRange().getValues();
